...
OP = {
 ...
 0x12:("ORA (,zp)",1),0x14:("TRB ",1),0x15:("ORA ,X",1),0x16:("ASL ,X",1),0x18:("CLC",0),
 0x19:("ORA ,Y",2),0x1a:("INC A",0),0x1c:("TRB ",2),0x1d:("ORA ,X",2),0x1e:("ASL ,X",2),
 0x1f:("BBR1 ",2),
 0x20:("JSR ",2),0x21:("AND (,X)",1),0x24:("BIT ",1),0x25:("AND ",1),0x26:("ROL ",1),
 0x27:("RMB1 ",1),0x28:("PLP",0),0x29:("AND #",1),0x2a:("ROL A",0),0x2c:("BIT ",2),
 0x2d:("AND ",2),0x2e:("ROL ",2),0x2f:("BBR1 ",2),
 0x30:("BMI ",1),0x31:("AND (,Y)",1),0x32:("AND (,zp)",1),0x34:("BIT ,X",1),
 0x35:("AND ,X",1),0x36:("ROL ,X",1),0x38:("SEC",0),0x39:("AND ,Y",2),0x3a:("DEC A",0),
 0x3c:("BIT ,X",2),0x3d:("AND ,X",2),0x3e:("ROL ,X",2),0x3f:("BBR2 ",2),
 0x40:("RTI",0),0x41:("EOR (,X)",1),0x45:("EOR ",1),0x46:("LSR ",1),0x47:("RMB2 ",1),
 0x48:("PHA",0),0x49:("EOR #",1),0x4a:("LSR A",0),0x4c:("JMP ",2),0x4d:("EOR ",2),
 0x4e:("LSR ",2),0x4f:("BBR3 ",2),
 0x50:("BVC ",1),0x51:("EOR (,Y)",1),0x52:("EOR (,zp)",1),0x55:("EOR ,X",1),
 0x56:("LSR ,X",1),0x58:("CLI",0),0x59:("EOR ,Y",2),0x5a:("PHY",0),0x5d:("EOR ,X",2),
 0x5e:("LSR ,X",2),0x5f:("BBR4 ",2),
 0x60:("RTS",0),0x61:("ADC (,X)",1),0x64:("STZ ",1),0x65:("ADC ",1),0x66:("ROR ",1),
 0x67:("RMB3 ",1),0x68:("PLA",0),0x69:("ADC #",1),0x6a:("ROR A",0),0x6c:("JMP (",2),
 0x6d:("ADC ",2),0x6e:("ROR ",2),0x6f:("BBR5 ",2),
 0x70:("BVS ",1),0x71:("ADC (,Y)",1),0x72:("ADC (,zp)",1),0x74:("STZ ,X",1),
 0x75:("ADC ,X",1),0x76:("ROR ,X",1),0x78:("SEI",0),0x79:("ADC ,Y",2),0x7a:("PLY",0),
 0x7c:("JMP (,X)",2),0x7d:("ADC ,X",2),0x7e:("ROR ,X",2),0x7f:("BBR6 ",2),
 ...
 0x95:("STA ,X",1),0x96:("STX ,Y",1),0x98:("TYA",0),0x99:("STA ,Y",2),0x9a:("TXS",0),
